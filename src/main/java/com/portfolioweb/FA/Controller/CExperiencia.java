...
import com.portfolioweb.FA.Dto.dtoExperiencia;
import com.portfolioweb.FA.Entity.Experiencia;
import com.portfolioweb.FA.Security.Controller.Mensaje;
import com.portfolioweb.FA.Security.Service.SExperiencia;
...
public class CExperiencia {
    ...
    public ResponseEntity<?> create(@RequestBody dtoExperiencia dtoexp){
        ...
        Experiencia experiencia = new Experiencia(dtoexp.getNombreE(),dtoexp.getPuesto(),dtoexp.getDescripcionE(),dtoexp.getLogo(),dtoexp.getPeriodo());
